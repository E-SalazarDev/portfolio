    ...
    <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl px-6">
        ...
        <div className="mt-9 flex gap-4 justify-center">
          <a href="#proyectos" className="bg-accent text-ink font-mono text-sm font-semibold px-6 py-3.5 rounded-lg shadow-lg shadow-accent/30 hover:shadow-accent/50 transition-shadow">
            Ver proyectos →
          </a>
          <a href="#" className="border border-white/10 text-paper font-mono text-sm px-6 py-3.5 rounded-lg hover:border-accent-light hover:text-accent-light transition-colors">
            Descargar CV
          </a>
        </div>
      </div>
