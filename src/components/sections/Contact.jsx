...
export default function Contact() {
  return (
    <>
      <section id="contacto" className="max-w-[1180px] mx-auto px-10 py-28">
        <div className="text-center bg-gradient-to-br from-panel to-panel2 border border-white/10 rounded-[20px] px-12 py-16">
          <span className="inline-flex items-center gap-2 text-xs tracking-widest text-accent-light border border-white/10 bg-accent/[0.06] rounded-full px-4 py-1.5 mb-5">
            ◆ Transmisión abierta
          </span>
