export const PROJECTS_DATA = {
    "smarthouse-ai": {
        ...
        video: "/media/projects/SmartHouse/smarthouse-preview.mp4",
        posterImage: "/media/projects/SmartHouse/smarthouse-preview.mp4",
        links: {
        ...
        gallery: [
            "/media/projects/SmartHouse/home1.png",
            "/media/projects/SmartHouse/home2.png",
            "/media/projects/SmartHouse/calcular_precio.png",
            "/media/projects/SmartHouse/comparador.png",
            "/media/projects/SmartHouse/busqueda_comparador.png",
        ],
        impact: [
            "Backend y API REST con Django: gestiona propiedades, expone endpoints de predicción, persiste datos en PostgreSQL e integra el modelo de ML con la aplicación.",
            "Pipeline de Machine Learning en Python: preprocesamiento, entrenamiento y evaluación de modelos (Linear Regression, Random Forest, Gradient Boosting) usando MAE, RMSE y R².",
            "Procesamiento de datos: limpieza, codificación de variables categóricas, escalado de numéricas y selección de features sobre el dataset Ames Housing.",
            "Integración end-to-end: conecté el frontend con la API REST para que las predicciones del modelo puedan consultarse desde la interfaz web.",
        ],
    },
